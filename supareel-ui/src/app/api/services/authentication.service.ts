...
import { ActivateAccountResponse } from '../models/activate-account-response';
...
export class AuthenticationService extends BaseService {
  ...
  static readonly AuthenticatePath = '/auth/activate-account';
   ...
   */
  authenticate$Response(params: Authenticate$Params, context?: HttpContext): Observable<StrictHttpResponse<ActivateAccountResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  authenticate(params: Authenticate$Params, context?: HttpContext): Observable<ActivateAccountResponse> {
    return this.authenticate$Response(params, context).pipe(
      map((r: StrictHttpResponse<ActivateAccountResponse>): ActivateAccountResponse => r.body)
    );
  }
